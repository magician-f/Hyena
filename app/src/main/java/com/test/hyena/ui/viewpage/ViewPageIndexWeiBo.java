...
import static com.test.hyena.ui.viewpage.Tool.*;
 ...
 */
public class ViewPageIndexWeiBo extends HorizontalScrollView {

    private String[] titles;
    private ArrayList<TextView> textViews = new ArrayList<>();
    private ViewPageIndexWeiBo.OnTextViewClick onTextViewClick;
    ...
    public ViewPageIndexWeiBo(Context context) {
        this(context, null);
    }

    public ViewPageIndexWeiBo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewPageIndexWeiBo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnTextViewClickListener(ViewPageIndexWeiBo.OnTextViewClick onTextViewClick) {
