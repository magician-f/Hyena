...
public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    private ViewPageIndexWeiBo viewPagerTitle;
    ...
    public MyOnPageChangeListener(Context context, ViewPager viewPager, DynamicLine dynamicLine, ViewPageIndexWeiBo viewPagerTitle, int allLength, int margin, int fixLeftDis) {
